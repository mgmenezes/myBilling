...
| REDE-01 | P1: A busca e os filtros ganham prova — ACs 1 a 6 | Execute | ACs 1 a 4 (T1); ACs 5 e 6 (T3) |
| REDE-02 | P1: O indicador e a lista param de poder divergir — ACs 1 a 4 | Execute | ACs 1, 2 e 4 provadas (T2); AC 3 em T4 |
