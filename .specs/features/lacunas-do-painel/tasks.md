...
**Tools**: nenhuma
**Done when**:
- [x] Buscar por parte de uma descrição deixa só ela na lista
- [x] O total exibido é o da linha que restou, não o do mês
- [x] Filtrar por categoria, meio e pessoa funciona pela tela
- [x] Recarregar a página com o filtro na URL preserva o filtro
- [x] Clicar num indicador do painel abre a lista já filtrada (REDE-02, AC 3)
**Tests**: e2e
**Gate**: build
...
**Tools**: nenhuma
**Done when**:
- [x] Um pendente em mês passado aparece como vencido
- [x] Filtrar por "Vencido" o devolve; por "Pendente", não
- [x] No mês corrente o mesmo lançamento aparece como pendente
- [x] **Mutante confirmado**: voltar a passar a competência da rota mata este percurso
**Tests**: e2e
**Gate**: build
